...
public class Biotech6_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biotech6_1);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.Biotech6_1);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Bio6_1 request = retrofit.create(Bio6_1.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Biotech6_1.this);
