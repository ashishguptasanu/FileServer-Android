...
public class Cs3_B_Sub12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs3__b__sub12);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.card_recycler_view_Cs3_sub12);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        cs3_12 request = retrofit.create(cs3_12.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Cs3_B_Sub12.this);
