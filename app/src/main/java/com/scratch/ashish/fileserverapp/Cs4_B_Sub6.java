...
public class Cs4_B_Sub6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs4__b__sub6);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.card_recycler_view_Cs4_sub6);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        cs4_6 request = retrofit.create(cs4_6.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Cs4_B_Sub6.this);
