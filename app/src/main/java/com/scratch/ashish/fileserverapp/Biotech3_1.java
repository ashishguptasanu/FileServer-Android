...
public class Biotech3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biotech3_1);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.Biotech3_1);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Bio3_1 request = retrofit.create(Bio3_1.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Biotech3_1.this);
