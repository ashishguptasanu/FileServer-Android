...
public class ScrollingActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card = (CardView) findViewById(R.id.Card_View1_1);
        card.setOnClickListener((View.OnClickListener) this);
        card1 = (CardView) findViewById(R.id.Card_View1_2);
        ...
        AdView mAdView = (AdView) findViewById(R.id.adViewSA);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.Card_View1_1:
                Intent intent = new Intent(this, ScrollingActivity1_1.class);
                startActivity(intent);
                break;
            case R.id.Card_View1_2:
                Intent intent2 = new Intent(this, MtechCs.class);
