...
public class Biotech2_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biotech2_3);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.Biotech2_3);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Bio2_3 request = retrofit.create(Bio2_3.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Biotech2_3.this);
