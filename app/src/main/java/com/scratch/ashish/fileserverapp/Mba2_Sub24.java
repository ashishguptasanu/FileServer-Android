...
public class Mba2_Sub24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mba2__sub24);
    ...
    private void initViews() {
        recyclerView = (RecyclerView) findViewById(R.id.card_recycler_view_mba2_sub24);
    ...
    private void loadJSON() {
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        RI2_24 request = retrofit.create(RI2_24.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Mba2_Sub24.this);
