...
public class PhysicsSubM2_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physics_sub_m2_3);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.card_recycler_view_physicsM2_3);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        PM2_3 request = retrofit.create(PM2_3.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, PhysicsSubM2_3.this);
