...
public class MCs2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs2_1);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.rvmcs2_1);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        csm2_1 request = retrofit.create(csm2_1.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, MCs2_1.this);
