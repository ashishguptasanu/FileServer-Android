...
public class Biotech5_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biotech5_2);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.Biotech5_2);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Bio5_2 request = retrofit.create(Bio5_2.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Biotech5_2.this);
