...
public class ScrollingActivity3_0 extends AppCompatActivity implements View.OnClickListener{
    CardView card, card1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scrolling_activity3_0);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        card = (CardView) findViewById(R.id.Card_View3_1);
        card.setOnClickListener((View.OnClickListener) this);
        card1 = (CardView) findViewById(R.id.Card_View3_2);
