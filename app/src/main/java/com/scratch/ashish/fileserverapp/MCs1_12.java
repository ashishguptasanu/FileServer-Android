...
public class MCs1_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcs1_12);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.rvmcs1_12);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        csm1_12 request = retrofit.create(csm1_12.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, MCs1_12.this);
