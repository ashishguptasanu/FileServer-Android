...
public class Ecug2_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecug2_7);
        ...
        AdView mAdView = (AdView) findViewById(R.id.adViewEcug2_7);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.card_recycler_view_ecug2_sub7);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        ecug2_7 request = retrofit.create(ecug2_7.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Ecug2_7.this);
