...
public class Biotech4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biotech4_2);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.Biotech4_2);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        Bio4_2 request = retrofit.create(Bio4_2.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Biotech4_2.this);
