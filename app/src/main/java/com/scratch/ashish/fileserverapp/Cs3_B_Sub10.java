...
public class Cs3_B_Sub10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cs3__b__sub10);
    ...
    private void initViews(){
        recyclerView = (RecyclerView)findViewById(R.id.card_recycler_view_Cs3_sub10);
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        cs3_10 request = retrofit.create(cs3_10.class);
        ...
        call.enqueue(new Callback<JSONResponse>() {
            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                adapter = new DataAdapter(data, Cs3_B_Sub10.this);
