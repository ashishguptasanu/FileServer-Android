...
public class ScrollingActivity2_0 extends AppCompatActivity implements View.OnClickListener{
    CardView card, card1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrolling_activity2_0);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        card = (CardView) findViewById(R.id.Card_View2_1);
        card.setOnClickListener((View.OnClickListener) this);
        card1 = (CardView) findViewById(R.id.Card_View2_2);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.Card_View2_1:
                Intent intent = new Intent(this, ScrollingActivity2_1.class);
